...
#   define LDLIBS_WIN "-Lresources/raylib_mingw/lib","-Lresources/EasyWinNoty","-lEasyWinNotification", "-l:libraylib.a","-lopengl32","-lgdi32","-lwinmm","-lcomdlg32","-lole32","-static", "-lpthread"
